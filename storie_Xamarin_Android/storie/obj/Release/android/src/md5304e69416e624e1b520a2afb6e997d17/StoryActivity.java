...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("storie.StoryActivity, storie, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", StoryActivity.class, __md_methods);
	}


	public StoryActivity () throws java.lang.Throwable
	{
		super ();
		if (getClass () == StoryActivity.class)
			mono.android.TypeManager.Activate ("storie.StoryActivity, storie, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
